enum LocaleType { en, fa, zh, nl, ru, it, fr, es, pl, pt, ko, ar, tr, jp, de, da, mn, bn, vi, hy, id }
...
final _i18nModel = {
  ...
  'fa': {
    ...
    'done': 'تایید',
    'today': 'امروز',
    'monthShort': ['فروردین', 'اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند'],
  ...
  'nl': {
    ...
    'done': 'Klaar',
    'today': 'Vandaag',
    'monthShort': ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Aug', 'Sep', 'Okt', 'Nov', 'Dec'],
    'monthLong': [
      'Januari',
      'Februari',
      'Maart',
  ...
  'fr': {
    ...
    'monthLong': ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'November', 'Décembre'],
